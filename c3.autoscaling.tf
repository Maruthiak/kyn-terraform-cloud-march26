  ...
  target_tracking_configuration {
    ...
    target_value           = 50.0 # Target 50% CPU .5 millicores of CPU utilization. When the average CPU utilization exceeds this value, the policy will trigger scaling actions.
